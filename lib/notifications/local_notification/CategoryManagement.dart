...
class CategoryManagement {
  ...
  Future<void> _addCategory(
    ...
    switch (importance) {
      case 1:
        channel = AndroidNotificationChannel(id, title,
            description: description, importance: Importance.min);
        break;
      case 2:
        channel = AndroidNotificationChannel(id, title,
            description: description, importance: Importance.low);
        break;
      case 3:
        channel = AndroidNotificationChannel(id, title,
  ...
  Future<void> _filterCategories() async {
    ...
    for (AndroidNotificationChannel channel in channels!) {
      isChannelAvailable =
          remoteChannels.map((e) => e['id']).contains(channel.id);
